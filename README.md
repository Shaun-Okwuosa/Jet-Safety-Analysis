...
1. **Invest in instrument training** — IMC is the strongest predictor of poor outcomes
2. **Maintain modern engine types** — Turbo Fan engines clearly outperform reciprocating engines
3. **Follow strict weather-minimum policies** to avoid IMC operations when possible
